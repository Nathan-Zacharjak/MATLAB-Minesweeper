...
while playGame == "y" || playGame == "Y"
    ...
    % Displaying initial fake hidden grid and initilising variables
    chosenValues = [];
    hiddenGrid = hideGrid(zeros(gridRows, gridColumns), chosenValues);
    gameOver = false;
    firstInput = true;
    ...
    while ~gameOver
        ...
        elseif ~validInput
            ...
            % If this is the first input, generate the grid, ensuring the
            % first chosen space isn't a mine
            if firstInput
                firstRow = chosenRow;
                firstColumn = chosenColumn;
            ...
            if isMine(chosenRow, chosenColumn, grid) && ~firstInput
